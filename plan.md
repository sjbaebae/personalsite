...
- I want code that’s “engineed enough” — not under-engineered (fragile, hacky) and not over-engineered (premature abstraction, unnecessary complexity).
...
- Give your opinionated recommendation and why.
